...
export type AuthorManyWhereInput = {
  ...
  cvjson_json_path_exists?: InputMaybe<Scalars['String']['input']>;
  /**
   ...
   */
  cvjson_value_recursive?: InputMaybe<Scalars['Json']['input']>;
...
export type AuthorUpdateInput = {
  ...
  cvjson?: InputMaybe<Scalars['Json']['input']>;
  /** cycle input for default locale (es) */
  cycle?: InputMaybe<Scalars['String']['input']>;
  /** detail input for default locale (es) */
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    searchCertifications(variables: SearchCertificationsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SearchCertificationsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SearchCertificationsQuery>({ document: SearchCertificationsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'searchCertifications', 'query', variables);
    },
